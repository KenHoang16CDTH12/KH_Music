...
public class TrackOfflineAdapter extends RecyclerView.Adapter<TrackOfflineAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        View rootView =
                LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_track_list, viewGroup, false);
